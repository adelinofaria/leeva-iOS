//
//  CampaignBrowserViewController.m
//  Leeva
//
...
@implementation CampaignBrowserViewController
...
- (void)loadView
{
    ...
    self.title = NSLocalizedString(@"campaign_details_browser_views", @"");
    ...
    column1.text = NSLocalizedString(@"campaign_browser_views_bar_column1", @"");
    ...
    column2.text = NSLocalizedString(@"campaign_browser_views_bar_column2", @"");
    ...
    labelTotalValue.text = _campaign.totalViewsOnBrowser;
    ...
    labelUniqueValue.text = _campaign.uniqueViewsOnBrowser;
    ...
    labelSecondValue.text = [NSString stringWithFormat:@"%d%%", [_campaign getBrowserViewsPercentage]];
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    ...
    if ([_campaign.browserViewArray count] > maxRows) {
        return maxRows;
    }
    else
        return [_campaign.browserViewArray count];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = [((NSDictionary *)[_campaign.browserViewArray objectAtIndex:indexPath.row]) objectForKey:@"Email"];
    cell.detailTextLabel.text = [((NSDictionary *)[_campaign.browserViewArray objectAtIndex:indexPath.row]) objectForKey:@"Value"];
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    if ([_campaign.browserViewArray count] > maxRows && y > h) {
        maxRows = maxRows+25;
