...
#import "CampaignOpensViewController.h"
#import "LeevaColor.h"


@implementation CampaignOpensViewController
...
- (void)loadView
{
    ...
    self.title = NSLocalizedString(@"campaign_details_opens", @"");
    ...
    column1.text = NSLocalizedString(@"campaign_opens_bar_column1", @"");
    ...
    column2.text = NSLocalizedString(@"campaign_opens_bar_column2", @"");
    ...
    labelTotalValue.text = _campaign.totalOpens;
    ...
    labelUniqueValue.text = _campaign.uniqueOpens;
    ...
    labelSecondValue.text = [NSString stringWithFormat:@"%d%%", [_campaign getOpensPercentage]];
...
- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    ...
    if ([_campaign.opensArray count] > maxRows) {
        return maxRows;
    }
    else
        return [_campaign.opensArray count];
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    cell.textLabel.text = [((NSDictionary *)[_campaign.opensArray objectAtIndex:indexPath.row]) objectForKey:@"Email"];
    cell.detailTextLabel.text = [((NSDictionary *)[_campaign.opensArray objectAtIndex:indexPath.row]) objectForKey:@"TotalOpens"];
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    if ([_campaign.opensArray count] > maxRows && y > h) {
        maxRows = maxRows+25;
